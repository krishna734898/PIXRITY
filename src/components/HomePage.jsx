    ...
    <>
      <nav className={scrolled ? 'nav-scrolled' : ''}>
        ...
        <div className="nav-right">
          <button className="contact-btn" onClick={openCalendly}>
            Contact Us
          </button>
      ...
      <section className="hero-section" id="home">
        <div className="hero-body">
          ...
          <div className="cta-container">
            <button className="btn-primary" onClick={() => scrollTo('#what-we-do')}>
              Explore Our Solutions
            </button>

            <button className="btn-secondary" onClick={openCalendly}>
              Book a Demo
            </button>
          </div>
        </div>
      ...
      <section className="what-section" id="what-we-do" ref={whatRef}>
        <div className={`section-inner ${whatVisible ? 'reveal' : ''}`}>
          ...
          <h2 className="section-headline">
            We <span className="headline-accent">sit at the intersection </span> of <br />
            XR and AI
          </h2>
      ...
      <section className="solutions-section" id="solutions" ref={solutionsRef}>
        <div className={`section-inner ${solutionsVisible ? 'reveal' : ''}`}>
          ...
          <div className="solutions-tabs">
            <button
              className={`sol-tab ${activeTab === 'solutions' ? 'sol-tab-active' : ''}`}
            ...
            <button
              className={`sol-tab ${activeTab === 'product' ? 'sol-tab-active' : ''}`}
              ...
              <div className="solution-tile product-video-tile" onClick={() => navigate('/product')}>
                <div className="product-tile-text">
                  ...
                  <p className="tile-desc">
                    Where AI generates production-ready 3D from a single image or prompt.
                  </p>
                  <a href="#" className="tile-link tile-link-accent">
                    Join Early Access
                  </a>
                </div>
      ...
      <section className="final-cta-section last-snap" id="final-cta" ref={cta2Ref}>
        <div className={`section-inner ${cta2Visible ? 'reveal' : ''}`}>
          ...
          <div className="cta-container">
            ...
            <button className="btn-secondary" onClick={() => scrollTo('#solutions')}>
              Explore Our Solutions
            </button>
          </div>
        </div>
