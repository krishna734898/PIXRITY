        ...
        {formSubmitted ? (
          ...
          <>
            ...
            <form className="ai-contact-form" onSubmit={handleSubmit}>
              ...
              <button type="submit" className="btn-primary ai-submit-btn">
                Send Message
              </button>
            </form>
          </>
          ...
          <div className="ai-functions-layout">
            <div className="ai-functions-tabs">
              {businessFunctions.map((fn, i) => (
                <button
                  key={i}
                  className={`ai-fn-tab ${activeFunction === i ? 'active' : ''} ${i === 6 ? 'ai-fn-tab-custom' : ''}`}
                  onClick={() => setActiveFunction(i)}
                >
